...
// Weekly ✅ = cals+protein within window on week avgs + gym ≥100%.
...
// Daily ladder = Super Saiyan set (moves every day). Weekly ladder = Game of Thrones level (moves every completed Tue-Sun week).
